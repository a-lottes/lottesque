...
import { latestSongs } from "@/data/data";
        ...
        >
          <div className="px-12 py-7 flex-col sm:flex-row bg-lime flex items-center gap-7">
            ...
            <div className="text-center sm:text-start">
              ...
              <p className="text-sm font-semibold">by Lottesque</p>
            </div>
          </div>
...
const Song = ({song}) => (
  <article className="flex hover:bg-slate-100 duration-500 transition-all px-9 py-3 justify-between items-center">
    <div>
      <h5 className="text-md font-bold ">{song.name}</h5>
      <p className="text-sm text-cyan font-normal">Lottesque</p>
    </div>
